...
In previous research, systematic exploration has proven useful in user-level code and distributed systems, yet a gap stands between the technique and the complex world of kernel-level concurrency debugging. In this thesis, we present techniques for bridging this gap.
