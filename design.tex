...
\begin{figure}[ht]
	...
	\end{tabular}
	\caption{Landslide judges whether the kernel has gotten stuck by analysing the structure of the execution tree. The red branches indicate non-terminating thread interleavings, which Landslide would identify by comparing them with their respective alternate interleavings.}
