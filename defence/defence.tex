...
\begin{frame}{Testing Techniques} % slide: sys ex vs stress testing
	...
	{\bf Systematic Exploration}\related{Flanagan '05}
	\begin{itemize}
...
% slide: 15-410 6-week project why we need it in kernels
\begin{frame}{Finding Races in Kernel-Space}
	% cite datacollider etc?
\end{frame}
...
\subsection{Anatomy}
% slide: pebbles, 15-410, simics
% slide: visualisation (here address challenge #1)

\subsection{Design}
% slide: using -- annotations & in-landslide instrumentation
% slide: POR -- mostly invisible, but (transition)

\subsection{Addressing Challenges} % rename
% slide: POR, modified - with runqueue conflicts, will get no pruning
% slide: ignoring shared memory accesses - venn diagram
...
\begin{frame}{Found Bugs} % slide: anecdotes: two deterministic bugs & two races
...
% slide: recap challenges and how we dealt with them
% slide: conclusion
