...
\revision{In this chapter, we discuss several problems that stand in the way of systematic exploration's applicability to kernel space. We address these problems partly with certain aspects of Landslide's design and partly by relying on the user to provide important information, which we discuss in Chapter~\ref{sec:design} and Chapter~\ref{sec:using} respectively.}
