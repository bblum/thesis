...
In order to garner student interest in Landslide, the author gave a lecture in 15-410 on systematic exploration in general and on Landslide specifically during the second-to-last week of the kernel project. The lecture slides are available at \url{http://www.cs.cmu.edu/~410-s12/lectures/L30_Landslide.pdf}.\footnote{
Also available at \url{http://bblum.net/landslide-lecture.pdf} and at \url{http://www.contrib.andrew.cmu.edu/~bblum/landslide-lecture.pdf}.}
...
\subsubsection{Descriptive Feedback}
...
The following feedback pertains to the user interface.
For Landslide to be appealing as a debugging tool, we should improve the user interface (or the infrastructure, in some cases) to address these issues.
...
\subsubsection{Landslide Victories}
% TODO
