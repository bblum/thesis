...
\begin{enumerate}
	...
	\item Fixing problems encountered getting Landslide to run, such as revising their kernel to meet Landslide's requirements and debugging incorrect instrumentation.
...
\begin{table}[t]
	...
	\begin{tabular}{|l||c|c|c|c|c|c||c|c|}
		...
		\hline \hline
		% ntaha/jmchow
		\multirow{2}{*}{Group 1} & 35 & {\footnotesize \em --} & {\footnotesize \em --} & 5 & {\footnotesize \em --} & {\footnotesize \em --} & {\footnotesize \em --} & {\footnotesize \em --} \\
		\cline{2-9}
		& 5 & 30 & 10 & 100 & {\footnotesize \em --} & {\footnotesize \em --} & 145 & {\footnotesize \em --} \\
		\hline
		% echo/margaret
		\multirow{2}{*}{Group 2} & 20 & 30 & 10 & 80 & {\footnotesize \em --} & 10 & 140 & 10 \\
		\cline{2-9}
		& 15 & 45 & 30 & 60 & {\footnotesize \em --} & 30 & 150 & 30 \\
		\hline
		% tpassaro
		...
		\hline
		% pjumde
		\multirow{2}{*}{Group 4} & 10 & 42 & 3 & 5 & 30 & {\footnotesize \em --} & 60 & 30 \\
		\cline{2-9}
		& 15 & 35 & {\footnotesize \em --} & 5 & 35 & {\footnotesize \em --} & {\footnotesize \em --} & 35 \\
		\hline
		% apodolsk
		Group 5 & 50 & 15 & {\footnotesize \em --} & 15 & {\footnotesize \em --} & {\footnotesize \em --} & {\footnotesize \em --} & {\footnotesize \em --} \\
		\hline
		Former TA & 40 & 20 & 3 & 95 & {\footnotesize \em --} & 30 & 158 & 30 \\
		\hline
		\hline
	...
	\end{tabular}
	\end{center}
	\caption{Self-reported times spent by users on each phase while using Landslide. ``--'' indicates a student reported spending no time on a particular phase. ``Required'' indicates the sum of the times from the first four phases; ``refinement'' inducates the sum from the last two phases.
	``--'' indicates that a user did not report spending any time on a phase; the ``required'' field is ``--'' if any of its represented phases are, and ``--'' fields are not reflected in the averages.}
