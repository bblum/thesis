...
\revision{In evaluating Landslide, we sought to answer seven overall questions.
...
\begin{itemize}
	...
	\item {\bf Ease of configuring decision sets.} Most students seemed to find the process of adding more decision points intuitive. One reported, ``quick and effective at detecting basic bugs/races.'' \revision{It could always be improved, but of all the parts of the user interface, this process seems to need it least.}
