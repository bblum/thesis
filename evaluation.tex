...
\begin{figure*}[t!]
	...
	All numbers represent the average from 5 trials, with the standard deviation given in parentheses. ``$\infty$'' indicates the bug was not found with stress testing (after 1 hour), or that Landslide's search did not finish (after 8 hours). % TODO: after how long? what timeout?
	}
	\label{fig:numbers}
\end{figure*}
